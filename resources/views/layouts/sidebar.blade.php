<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link">
        <img src={{asset('dist/img/platformaedulogo.png')}} class="brand-image">
        <img src="{{asset('dist/img/platformaedu.png')}}">
        {{--        <span class="brand-text font-weight-light">Platforma EDU</span>--}}
    </a>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview">
                    <a href="#" class="nav-link">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <i class="far fa-circle nav-icon"></i>
                        <p><i>Kategorie</i> <i class="right fas fa-angle-left"></i>
                        </p>
                    </a>
                    @php
                        $id = Auth::user()->id;
